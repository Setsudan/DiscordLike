...
public class ChannelController {
    ...
    @Operation(
    summary = "Récupérer tous les channels",
    description = "Renvoie une liste de tous les channels disponibles.",
    responses = {
    ...
    @Operation(
    summary = "Récupérer un channel par son identifiant",
    description = "Renvoie le channel correspondant à l'ID fourni, ou une erreur 404 si non trouvé.",
    responses = {
        @ApiResponse(responseCode = "200", description = "Channel trouvé",
            content = @Content(schema = @Schema(implementation = StandardResponse.class))),
        @ApiResponse(responseCode = "404", description = "Channel introuvable",
            content = @Content(schema = @Schema(implementation = StandardResponse.class))),
        @ApiResponse(responseCode = "500", description = "Erreur serveur")
        }
    )
    ...
    description = "Crée un nouveau channel associé à l'utilisateur connecté.",
    responses = {
        @ApiResponse(responseCode = "201", description = "Channel créé avec succès",
            content = @Content(schema = @Schema(implementation = StandardResponse.class))),
    ...
    @Operation(
    summary = "Mettre à jour un channel existant",
    description = "Met à jour un channel avec les nouvelles données et vérifie les droits de l'utilisateur.",
    responses = {
        @ApiResponse(responseCode = "200", description = "Channel mis à jour",
            content = @Content(schema = @Schema(implementation = StandardResponse.class))),
    ...
    description = "Supprime un channel existant si l'utilisateur en a les droits.",
    responses = {
